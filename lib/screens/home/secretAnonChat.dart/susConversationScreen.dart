...
class SusConversationScreen extends StatefulWidget {
  final String chatRoomId;
  final Wiggle wiggle;
  final List<Wiggle> wiggles;
  final UserData userData;

  SusConversationScreen(
      {this.wiggles, this.chatRoomId, this.wiggle, this.userData});
  @override
  _SusConversationScreenState createState() => _SusConversationScreenState();
}

final f = new DateFormat('h:mm a');

class _SusConversationScreenState extends State<SusConversationScreen> {
  String message;
  ...
  sendMessage() {
    if (message.isNotEmpty) {
      ...
      DatabaseService()
          .addSusConversationMessages(widget.chatRoomId, messageMap);
      DatabaseService()
          .feedReference
        ...
        'ownerName': widget.wiggle.nickname,
  ...
  @override
  void initState() {
    DatabaseService().getSusConversationMessages(widget.chatRoomId).then((val) {
      setState(() {
                ...
                title: Row(
                  children: <Widget>[
                    ...
                    FlatButton(
                      ...
                      child: Text('${widget.wiggle.nickname} *'),
                      onPressed: () {
