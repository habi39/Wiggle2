...
class Game2 extends StatefulWidget {
  UserData userData;
  Wiggle wiggle;
  Game2(this.wiggle, this.userData);
...
class _Game2State extends State<Game2> {
  ...
  void playGame(GameButton gb) {
    setState(() {
      ...
      DatabaseService().updateGame(
        getGameRoomID(widget.userData.email, widget.wiggle.email),
        player1,
        player2,
      );
      gb.enabled = false;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: Text('Play with ${widget.wiggle.name}'),
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Text(
            activePlayer == 1 ? 'Your turn' : '${widget.wiggle.name}\'s turn',
